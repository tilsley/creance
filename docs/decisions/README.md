...
| [0019](0019-inference-gateway.md) | Promote the inference gateway to a standalone, identity-bound choke point — verified workload identity (OIDC), claim-bound isolation, multi-scope atomic budget, CRD self-service (extends 0004/0013, hardens 0014/0015) | Proposed |
