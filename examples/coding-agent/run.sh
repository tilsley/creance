...
# with bob's claim ($5). The claim names the real Bedrock id — the bespoke /v1/generate wire
# resolves the claim's model server-side and hands it to Bedrock verbatim (no alias map).
